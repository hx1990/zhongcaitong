...
class DistributionWithMoeny extends Component{
    constructor(){
        super()
        this.state={
          data :[]
    ...
    render(){
        return (<div className="express">
          <div className="DetailList">资费清分表</div>
          <div className="shaxuan">
              ...
              <Select defaultValue="时间" style={{ width: 120 }} onSelect={this.renZheng.bind(this)}>
                    <Option value="timemore">由近到远</Option>
                    <Option value="time">由远到近</Option>
              </Select>
              <Select defaultValue="资费" style={{ width: 120 }} onSelect={this.renZheng.bind(this)}>
                    <Option value="timemore">由高到低</Option>
                    <Option value="time">由低到高</Option>
              </Select>
              <Select defaultValue="运费" style={{ width: 120 }} onSelect={this.renZheng.bind(this)}>
                    <Option value="timemore">由高到低</Option>
              ...
              <Select defaultValue="代理" style={{ width: 120 }} onSelect={this.renZheng.bind(this)}>
...
export default DistributionWithMoeny
...
const express = [
    ...
    { title: '快递员/公司',   dataIndex: 'type',  key: 'type', },
...
class IncomeList extends Component{
    ...
    render(){
        return (<div className="express">
          <div className="DetailList">收入清单</div>
          <div className="shaxuan">
              <Select defaultValue="按收入成员" style={{ width: 120 }} onSelect={this.renZheng.bind(this)}>
                    <Option value="done">快递员</Option>
                    <Option value="die">快递公司</Option>
              </Select>
